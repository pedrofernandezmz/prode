...
def scrap_fechas():
    ...
    game_info_array = scrap_links(response)
    ...
    if response.status_code == 200:
        ...
        with open("partido.csv", "w", newline="", encoding="utf-8") as csvfile:
            ...
            column_names = ["Dia", "Tiempo", "Equipo1", "Equipo2", "Resultado1", "Resultado2", "Goles1", "Goles2", "Game-info"]
            ...
            for i, data_all in enumerate(zip(repeated_game_days, game_time, game_team1, game_team2, game_result1, game_result2, game_goals1, game_goals2)):
                row = [data.get_text(strip=True).replace("'", "' ") for data in data_all]
